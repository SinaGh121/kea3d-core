...
## cad-native-colors.step

- Source: the same internally authored generator with `--single-root`.
- License: MPL-2.0.
- Purpose: Windows-native rebuild regression; 12 triangles, six colored faces,
  two distinct colors. The multi-root WASM fixture remains unchanged.
