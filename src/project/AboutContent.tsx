  ...
  return (
    <div className="grid gap-3">
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <Button variant="outline" size="sm" disabled title="Matching source archive is prepared locally; publication is pending."><Code2 /> Source pending</Button>
      ...
      <div className="grid gap-1 text-[10px] leading-relaxed text-muted-foreground"><p>This build contains the MPL-licensed Kea3D Core. No separately licensed Pro features are included.</p><p>Internal candidate: matching source publication and distribution review are pending.</p><p>Model files are processed locally and are not uploaded by Kea3D.</p></div>
    </div>
  );
}
