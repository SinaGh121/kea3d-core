...
export function blendCompatibilityMessage(): string {
  return 'Blender (.blend) files are not supported. In Blender, use File > Export > glTF 2.0 and choose GLB, then open the GLB in Kea3D. The source file is unchanged.';
}
